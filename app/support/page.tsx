...
export default function SupportPage() {
  return (
    <PublicPage title="Support" intro="Need help connecting Instagram, validating a rule, or preparing a Meta App Review submission? We’ll help you get to a reproducible test case.">
      ...
      <p>Email <a href="mailto:support@dmsetu.app">support@dmsetu.app</a> with your workspace name, Instagram username, the automation name, and the approximate time of the issue. Never include a password, access token, or signed request.</p>
      ...
      <p>DMSetu supports deterministic keyword or any-comment/DM triggers, optional keyword or post conditions, private replies to comments, text DMs, link messages, and button messages through Meta’s official APIs. Follower-triggered DMs, scraping, WhatsApp, and AI-generated replies are not part of this MVP.</p>
      <h2>Review access</h2>
