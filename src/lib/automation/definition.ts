import { z } from "zod";
import type { FlowDefinition, FlowDefinitionV1, FlowDefinitionV2 } from "./types";
...
const flowV2Schema = z
  .object({
    ...
    openingMessage: z.object({ text: campaignText, optInButtonLabel: quickReplyLabel }),
    followGate: z.object({
      required: z.literal(true),
      notFollowingMessage: campaignText,
